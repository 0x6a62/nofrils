" Name: No Frils Jb Colorscheme
" Author: 0x6a62 (on Github)
...
hi Parenthesis ctermfg=184 guifg=#d7d700
autocmd BufRead,BufNewFile * syn match Parenthesis /[()\[\]{}]/ | hi Parenthesis ctermfg=184 guifg=#d7d700


" Baseline
hi Normal term=NONE cterm=NONE ctermfg=255 ctermbg=87 gui=NONE guifg=#eeeeee guibg=#5fffff
...
hi MatchParen term=NONE cterm=NONE ctermfg=15 ctermbg=4 gui=NONE guifg=#000000 guibg=yellow
...
function! NofrilsFocusComments()
    hi Comment term=NONE cterm=NONE ctermfg=255 ctermbg=235 gui=NONE guifg=#ffeeff guibg=#002600
...
function! NofrilsNormal()
    hi Comment term=NONE cterm=NONE ctermfg=242 ctermbg=234 gui=NONE guifg=#a8a8a8 guibg=NONE
    hi Normal term=NONE cterm=NONE ctermfg=254 ctermbg=234 gui=NONE guifg=#ffffff guibg=#262626
    hi LineNr term=NONE cterm=NONE ctermfg=8 ctermbg=bg gui=NONE guifg=#808080 guibg=bg
    hi Character term=NONE cterm=NONE ctermfg=214 ctermbg=NONE gui=NONE guifg=#ffa700 guibg=NONE
    hi String term=NONE cterm=NONE ctermfg=214 ctermbg=NONE gui=NONE guifg=#ffa700 guibg=NONE
    hi Parenthesis ctermfg=184 guifg=#d7d700
